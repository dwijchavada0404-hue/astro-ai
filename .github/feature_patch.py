...
# Add the new event in both sets that list spouse-family immediately before profession.
for label in ("primary priority", "comparison specific events"):
    s = replace_once(s,
    '''        "spouse_family_background",\n        "spouse_profession",\n''',
    '''        "spouse_family_background",\n        "spouse_age_profile",\n        "spouse_profession",\n''', label)

# Age-profile questions are descriptive/probability.
s = replace_once(s,
'''    if primary_event in (\n        "spouse_traits",\n        "spouse_appearance",\n''',
...
# Use function-scoped anchors rather than brittle tuple-neighbour assumptions.
