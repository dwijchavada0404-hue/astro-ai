...
def _chart():
    return {"houses":{"2":{"lord":"Venus"},"4":{"lord":"Moon"},"5":{"lord":"Jupiter"},"8":{"lord":"Saturn"},"9":{"lord":"Mars"},"11":{"lord":"Mercury"},"12":{"lord":"Sun"}},"planets":{"Venus":{"house":4},"Moon":{"house":5},"Jupiter":{"house":9},"Saturn":{"house":8},"Mars":{"house":11},"Mercury":{"house":2},"Sun":{"house":12}},"dashas":{"mahadashas":[{"planet":"Jupiter","start":"2022-01-01T00:00:00+00:00","end":"2028-12-31T23:59:59+00:00","antardashas":[{"planet":"Saturn","start":"2026-01-01T00:00:00+00:00","end":"2028-12-31T23:59:59+00:00"}]},{"planet":"Venus","start":"2029-01-01T00:00:00+00:00","end":"2033-12-31T23:59:59+00:00","antardashas":[{"planet":"Jupiter","start":"2029-01-01T00:00:00+00:00","end":"2033-12-31T23:59:59+00:00"}]}]}}


def _now(): return datetime(2026, 8, 21, tzinfo=timezone.utc)


def test_when_will_i_have_children_routes_to_timing_engine():
    ...
    assert "pregnancy" in result["limitation"].lower()
...
def test_family_stability_routes_to_direction():
    assert route_family_children_question_v1(_chart(), "How is my family stability?", _now())["route"] == "family_children_direction_v1"
