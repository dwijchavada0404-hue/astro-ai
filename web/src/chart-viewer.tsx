  ...
  return <div className="chart-scrim" role="presentation">
    <section className="chart-dialog" role="dialog" aria-modal="true" aria-labelledby="birth-chart-title">
      ...
      {chart && <div className="chart-content">
        ...
        <section className="chart-section"><div className="chart-section-title"><h4>North Indian Kundli</h4><span>Visual house map</span></div><NorthIndianKundli houses={chart.houses} planets={chart.planets} /></section>
