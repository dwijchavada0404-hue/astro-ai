...
const LEGAL_CONTENT: Record<LegalPageId, { title: string; intro: string; sections: { heading: string; body: string }[] }> = {
  privacy: {
    ...
    sections: [
      ...
      { heading: "Storage and service providers", body: "Application data is hosted on Railway. Authentication is provided by Auth0. These providers process information on AstroAI’s behalf under their respective security and privacy terms. Internet access and service delivery may involve processing across countries." },
